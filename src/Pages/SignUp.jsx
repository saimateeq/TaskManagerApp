    ...
    return(
        <div className="w-full flex flex-col items-center h-screen">
            <form className="w-11/12 sm:w-1/2 flex flex-col gap-7 bg-gray-100 mt-4 p-4 border border-gray-300 rounded-md shadow-md">
                <h1 className="text-2xl font-bold m-auto">Sign Up</h1>
                <div className="flex flex-col gap-2">
                    <label htmlFor="name" className="text-sm font-bold">Name</label>
                    <input type="text" id="name" className="border border-gray-300 rounded-md p-2 focus:outline-none focus:ring-2 focus:ring-blue-500" placeholder="Enter your name" required />
                </div>
                <div className="flex flex-col gap-2">
                ...
                <button type="submit" className="bg-blue-500 text-white rounded-md p-2 hover:bg-blue-600">Sign Up</button>
            </form>
        </div>
    )
}
